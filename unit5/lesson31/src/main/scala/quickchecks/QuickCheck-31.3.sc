...
// You have declared A a regular class rather than a case class; class equality requires
...
// On the other hand, case class equality only requires two classes to be the same if they have
// the same structure. If you change the code to declare A a case class, you would receive
