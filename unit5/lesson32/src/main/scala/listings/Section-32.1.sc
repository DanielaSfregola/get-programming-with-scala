List(0.4, -2, 3).sorted
// val res0: List[Double] = List(-2.0, 0.4, 3.0)

List("my", "example").sorted
// val res1: List[String] = List(example, my)

List.empty[Double].sorted
// val res2: List[Double] = List()


List(0.4, -2, 3).sortBy(i => -i)
// val res3: List[Double] = List(3.0, 0.4, -2.0)
...
// val res4: List[A] = List(A(1,a), A(9,a), A(1,z))
// Ordering by the field text first, then by n


List(1, 3, 2).reverse
// val res5: List[Int] = List(2, 3, 1)
...
// val res7: List[Int] = List(2, 1, 3)

Random.shuffle(List(1, 2, 3))
// val res8: List[Int] = List(3, 2, 1)
