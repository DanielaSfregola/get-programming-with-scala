...
// val res0: scala.collection.immutable.Map[String,String] = Map(Italy -> Rome, UK -> London)

Map("Rome" -> "Italy", "London" -> "UK").map {
  case (capital, country) => country -> capital
}
// val res1: scala.collection.immutable.Map[String,String] = Map(Italy -> Rome, UK -> London)
...
// val res3: scala.collection.immutable.Iterable[String] = List(Rome is the capital of Italy, London is the capital of UK)
...
// val res0: scala.collection.immutable.Map[Int,Int] = Map(1 -> 2)
...
// val res1: scala.collection.immutable.Iterable[Int] = List(2)
