...
// val b2: scala.util.Try[Int] = Failure(java.lang.Exception: error!)
...
// val b4: scala.util.Try[Int] = Success(5)
// equivalent to Try.apply(10/2)

val b5: Try[Int] = Try(10/0)
// val b5: scala.util.Try[Int] = Failure(java.lang.ArithmeticException: / by zero)
