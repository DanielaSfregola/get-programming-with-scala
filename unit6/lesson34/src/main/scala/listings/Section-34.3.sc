Set(0, 2, 4).map(_ * 3)
// val res0: scala.collection.immutable.Set[Int] = Set(0, 6, 12)
...
// val res0: scala.collection.immutable.Set[Int] = Set(1, 2)

Set(Set(1), Set(1)).flatten
// val res1: scala.collection.immutable.Set[Int] = Set(1)
// duplicated element 1 is shown once

Set(Set(), Set()).flatten
// val res2: scala.collection.immutable.Set[Nothing] = Set()
...
// val res1: scala.collection.immutable.Set[String] = Set()
