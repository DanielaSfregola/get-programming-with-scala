...
// The function should compute the power of a number as follows: if the parameter exponent
// has value three and base has value two, then the function should compute 2^3.
